...
class _PanoramaPageState extends State<PanoramaPage> {
  ...
  List<Image> panoImages = [
    Image.asset('assets/panorama/panorama.jpg'),
    Image.asset('assets/panorama/panorama2.webp'),
    Image.asset('assets/panorama/panorama_cropped.webp'),
  ];
    ...
    switch (_panoId % panoImages.length) {
      case 0:
        panorama = Panorama(
          ...
          child: Image.asset('assets/panorama/panorama.jpg'),
        );
        break;
      case 2:
        panorama = Panorama(
          ...
          child: Image.asset('assets/panorama/panorama_cropped.jpg'),
        );
        break;
      default:
        panorama = Panorama(
