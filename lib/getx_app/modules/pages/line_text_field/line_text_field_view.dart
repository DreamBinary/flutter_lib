...
class LineTextFieldPage extends StatelessWidget {
  const LineTextFieldPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final logic = Get.find<LineTextFieldLogic>();
    final state = Get.find<LineTextFieldLogic>().state;
...
class LineTextField extends StatelessWidget {
  ...
  LineTextField(
      {this.fontSize = 25, this.fontHeight = 1.5, this.maxLines = 1, Key? key})
      : super(key: key);
